...
function addPacman() {
  cells[pacmanPostion].classList.add('pacman')
}

function removePacman() {
  cells[pacmanPostion].classList.remove('pacman')
}
