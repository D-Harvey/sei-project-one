      ...
      if (ghostDistanceX[i] >= ghostDistanceY[i]){
        ...
        if (pacmanPosition >= ghostPosition[i]) {
...

          {
            ...
            console.log('here 5')
            // must be border below and to right, so let's go up
            removeGhost()
            ghostPosition[i] -= 20
            addGhost()
            return
          ...
          if (!cells[ghostPosition[i] - 1].classList.contains('noGoZoneCells')){
            ...
            console.log('here 5')
            // must be border above and to left, so let's go down
            removeGhost()
            ghostPosition[i] += 20
            addGhost()
            return
        ...
        if (pacmanPosition > ghostPosition[i]) {
          ...
          if (!cells[ghostPosition[i] + 20].classList.contains('noGoZoneCells')){
            ...
            // must be border below and to right, so let's go left
            removeGhost()
            ghostPosition[i] --
            addGhost()
            return
          ...
          if (!cells[ghostPosition[i] - 20].classList.contains('noGoZoneCells')){
            ...
            console.log('here vert 5')
            // must be border above and to left, so let's go right
            removeGhost()
            ghostPosition[i] ++
            addGhost()
            return
